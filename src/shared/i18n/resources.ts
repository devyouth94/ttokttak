    ...
    translation: {
      ...
      settings: {
        ...
        environment: {
          ...
          appLanguageHint: "Choose the app display language on this device.",
          appLanguageLocalOnly: "Saved only on this device.",
          languageEnglishHint: "Set the app display language to English.",
          languageKoreanHint: "Set the app display language to Korean.",
          saveErrorMessage:
            "Could not save the app display language. Please try again later.",
          saveErrorTitle: "Could not save language",
          section: "Environment",
          syncErrorMessage:
            "The app display language changed, but scheduled notifications could not be updated. They will be updated when you reopen the app.",
  ...
  ko: {
    translation: {
      ...
      settings: {
        ...
        environment: {
          appLanguage: "앱 표시 언어",
          appLanguageHint: "현재 기기의 앱 표시 언어를 선택해요.",
          appLanguageLocalOnly: "현재 기기에만 저장됩니다.",
          languageEnglishHint: "앱 표시 언어를 English로 설정해요.",
          languageKoreanHint: "앱 표시 언어를 한국어로 설정해요.",
          saveErrorMessage:
