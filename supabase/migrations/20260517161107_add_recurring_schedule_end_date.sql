...
alter table public.recurring_item_schedule_versions
  ...
  drop constraint if exists recurring_item_schedule_versions_once_end_date_check,
  add constraint recurring_item_schedule_versions_once_end_date_check check (
